      ...
      <div id='ui' class='update_frame'>     
        ...
        <div class='content'>
          <form id='updateData'>
            ...
            <input type="text" id="MENU_CODE" name="MENU_CODE" data-update="db" class="left short" data-modify="true" required="required" data-pageframe="ui"  data-lovbtn="MENU_LOV"  data-param="MENU_CODE"/>
      ...
      <div id='query' class='query_frame'>     
        ...
        <div class='content'>
          <form>
            ...
            <input type="text" id="MENU_NAME_Q" name="MENU_NAME" data-update="db" class="left mid" data-modify="true" data-pageframe="query"  data-lovbtn="MENU_LOV_Q"  data-param="MENU_NAME"/>
