      ...
      <div id="query" class="pop_frame row-4">     
        ...
        <div class="content row-4">
          <form>
            ...
            <br style="clear:both"/>
            <label for="END_DATE_F" class="left md">失效日期:</label>
            <input type="text" id="END_DATE_F" name="END_DATE_F" class="left lg" data-datatype="date" placeholder="起始失效日期"/>
            <label class="left blank"></label>
            <input type="text" id="END_DATE_T" name="END_DATE_T" class="left lg" data-datatype="date" placeholder="截止失效日期"/>
          </form> 
        </div>
        <div class='foot'>             
      ...
      <div id="ui" class="pop_frame row-5">     
        ...
        <div class="content row-5">
          <form id='updateData'>
            ...
            <label for="RESP_NAME" class="left md">职责</label> 
            <input type="text" id="RESP_NAME" name="RESP_NAME" data-update="db" class="left md" data-modify="true" required="required" data-pageframe="ui"  data-lovbtn="RESP_LOV" data-param="RESP_NAME"/>
            ...
            <input type="text" id="GROUP_NAME" name="GROUP_NAME" data-update="db" class="left md" data-modify="true" data-pageframe="ui" data-validurl="lov/validGroupName.do" data-queryurl="lov/getGroupId.do" data-lovbtn="GROUP_LOV" data-hiddenid=["GROUP_ID"] data-hiddenval=["GROUP_ID"] data-param="groupName"/>
        ...
        <div class="content row-3">
          <form id="updateDetailData">
            ...
            <input type="hidden" id="ORG_ID" name="ORG_ID" data-update="db" readonly="readonly"/>
             <br style="clear:both"/>
            <label for='START_DATE_DETAIL' class="left md">启用日期</label>
            <input type='text' id='START_DATE_DETAIL' name='START_DATE' data-update="db" data-datatype="date" required='required' class="left lg"/>
            <label for='END_DATE_DETAIL' class="left md">失效日期</label>
            <input type='text' id='END_DATE_DETAIL' name='END_DATE' data-update="db" data-datatype="date" class="left lg"/>
          </form>
        </div>
        <div class='foot'>       
