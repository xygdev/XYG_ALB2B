...
<body class="x404 x404_index">
  ...
  <div class="container no-page-wrapper">
    ...
    <div class="major-tom">
        <div class="toms-text">
          <p class="text-1">I Wanna Go Back To The Earth...</p>
  ...
  <script type="text/javascript">
      $('#quit').on('click',function(){
          if (top != self) {
             ...
             $(this).attr('href','http://192.168.88.41:8080/B2B_Demo_Version01/');
             window.location.href('http://192.168.88.41:8080/B2B_Demo_Version01/');
          }  
      });
